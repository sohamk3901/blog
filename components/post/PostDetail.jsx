        ...
        <div className="px-4 lg:px-0">
          <div className="flex items-center mb-8 w-full border-b pb-6 border-slate-900">
            <div className="hidden md:flex justify-center lg:mb-0 lg:w-auto mr-8 items-center">
              ...
              />
              <p className="inline align-middle text-slate-950 ml-2 font-medium text-lg">{post.author.name}</p>
            </div>
            <div className="font-medium text-slate-950">
              ...
              <span className="align-middle text-slate-950">{moment(post.createdAt).format('MMM DD, YYYY')}</span>
            </div>
          </div>
          <h1 className="mb-8 text-3xl text-slate-950 font-semibold">{post.title}</h1>
