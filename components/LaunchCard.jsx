...
const LaunchCard = ({launch}) => {
  return (
    <div className='bg-slate-100 shadow-lg rounded-lg p-4 lg:p-8 pb-12 mb-8'>
      ...
      <div>
        <h1 className='transition duration-700 text pl-4 text-slate-950 mb-4 mt-4 cursor-pointer hover:text-amber-800 text-3xl font-semibold'>
      ...
      <div className='block lg:flex text-center items-center pl-4 mt-4 mb-8 w-full'>
        ...
        <div className="font-medium text-slate-950 text-left">
          ...
          <span className="align-middle ml-2">{launch.dateAndTime ? moment(launch.dateAndTime).format('DD MMM, YYYY, h:mm:ss a'): 'TBA'}</span>
        </div>  
